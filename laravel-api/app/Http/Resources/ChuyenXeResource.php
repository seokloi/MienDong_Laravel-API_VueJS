...
class ChuyenXeResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'ConLai' => nv_banve::where('id_Chuyen',$this->id)->where('TenKhachHang',NULL)->where('paymenting',0)->get()->count(),
            'DaDat' => nv_banve::where('id_Chuyen',$this->id)->whereNotNull('TenKhachHang')->get()->count(),
