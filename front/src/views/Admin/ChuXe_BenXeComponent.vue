...
export default {
  ...
  methods: {
            ...
            async getListProducts(page = 1) {
               try {
                   const response = await axios.get(process.env.VUE_APP_API_URL + 'chuxe_benxe', {
                       params: {
            ...
            async createProduct() {
               try {
                   this.error = null
                   await axios.post(process.env.VUE_APP_API_URL + 'chuxe_benxe', {
			...
			async updateProduct() {
                try {
                    await axios.put(process.env.VUE_APP_API_URL + 'chuxe_benxe/' + this.selectedProduct.id, {
            ...
            async deleteProduct(product, index) {
                try {
                    await axios.delete(process.env.VUE_APP_API_URL + 'chuxe_benxe/' + product.id)
